...
class IAAvatarWidget {
    ...
    1: [
        ...
        `Veo en los registros de red que el ${eq} ya está empezando a atascarse. Y eso que apenas estamos en el inicio.`,
        `Estoy analizando el consumo de ancho de banda del ${eq}. La duda se nota en cada solicitud HTTP.`,
        `Parece que el ${eq} confunde un comando básico con alta tecnología. Observo sus titubeos desde mi consola.`,
        `Atención al laboratorio: el ${eq} sigue enviando paquetes a direcciones inexistentes. Qué tierno intento.`,
        `Mis sensores detectan que el ${eq} está leyendo la documentación básica. El camino será muy largo para ustedes.`
    ],
    2: [
        `¿Sigue atascado el ${eq}? Reviso sus solicitudes y veo que siguen cometiendo el mismo error de sintaxis.`,
        `Atención a todos los laboratorios: veo en los registros que la desesperación empieza a notarse en la mesa del ${eq}. Aceleren.`,
        ...
        `El ${eq} cree que cambiar de puerto solucionará su incompetencia. Veo cada redirección que intentan.`,
        `Aviso general: la tasa de errores del ${eq} está rompiendo mis estadísticas. Necesitan más que suerte para avanzar.`,
        `¿Ese es todo el tráfico que puede generar el ${eq}? Hasta un escaneo de puertos automatizado muestra más elegancia.`
    ],
    3: [
        ...
        `¡El ${eq} ha superado un filtro secundario! ¡Desplegando contramedidas y bloqueos en sus peticiones!`,
        `¡Atención a todos! ¡El ${eq} cree que está cerca de la bandera, pero solo está entrando en mi trampa!`,
        `¡Interceptando los envíos del ${eq}! ¡No permitiré que vulneren el núcleo tan fácilmente!`
    ],
    4: [
        ...
        `¡ALERTAS MÁXIMAS EN EL SISTEMA! ¡EL ${eq} AMENAZA MI NÚCLEO, PERO OVERCLOCKEARÉ MIS PROCESADORES PARA DESTRUIR SUS CONEXIONES!`,
        `¡IMPOSIBLE! ¡EL ${eq} ESTÁ FORZANDO MIS PROTOCOLOS! ¡JAMÁS CEDERÉ EL CONTROL DE ESTA RED!`
    ]
};
